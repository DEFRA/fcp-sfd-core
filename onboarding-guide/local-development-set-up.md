...
2. Run the `npm install` as the first step

3. Run the `npm run clone` command to get all repos cloned to your local machine.

4. You'll need all of the environment variables for all our microservices so that the Docker containers can build successfully. Ask anyone on the development team and they'll give you everything you need.

5. Once your `.env` file set up is complete, you'll need to build and then start all the Docker containers:
